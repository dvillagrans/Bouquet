  ...
  return (
    <div className="min-h-screen p-8 relative bg-[#f5f3f0] bg-[linear-gradient(rgba(0,0,0,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.05)_1px,transparent_1px)] bg-[size:20px_20px]">
      ...
      <div className="text-center mb-8">
        <h2 className="text-[#8B4B6B] text-3xl font-serif italic">Pago</h2>
      </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 text-center shadow-sm border border-[#8B4B6B]/20">
              <ImageWithFallback 
                ...
                className="w-16 h-16 object-cover rounded-full mx-auto mb-3"
              />
              <p className="text-sm text-[#8B4B6B] font-medium">Compartido</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <label className="flex items-center space-x-3 cursor-pointer">
              ...
              />
              <span className="text-gray-700">Pago Individual - Pago todo el total</span>
            </label>
            ...
            <label className="flex items-center space-x-3 cursor-pointer">
              <input
                ...
                className="text-[#8B4B6B]"
              />
              <span className="text-gray-700">Factura Compartida - Selecciono lo que consumí</span>
            </label>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-sm border border-[#8B4B6B]/20">
          ...
          {paymentMethod === 'shared' && (
            <p className="text-sm text-gray-600 mt-2">
              En el siguiente paso podrás seleccionar solo los ítems que consumiste
            </p>
          )}
        </div>
