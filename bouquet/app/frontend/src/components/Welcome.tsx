        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 shadow-sm border border-[#8B4B6B]/20">
          <div className="space-y-4 text-left">
            <p className="text-sm text-gray-700">
              <span className="font-medium">✿ Bienvenido:</span> Escanea el código QR de tu mesa para ver la cuenta y dividir los gastos
            </p>
            <p className="text-sm text-gray-600">
              Selecciona solo lo que consumiste y paga tu parte de forma fácil y rápida
            </p>
          </div>
        </div>
