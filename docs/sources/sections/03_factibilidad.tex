...
\midrule
Next.js 14 & Framework frontend + API & 14.x & 44\% de desarrolladores lo usan activamente \cite{state_of_js_2023} & MIT \\
\rowcolor{altrow}
React 18 & Biblioteca UI & 18.x & 84\% de los desarrolladores web la usan \cite{state_of_js_2023} & MIT \\
TypeScript 5 & JS tipado & 5.x & 38.87\% de desarrolladores la usan \cite{stackoverflow_2023_results} & Apache 2.0 \\
\rowcolor{altrow}
...
PostgreSQL 15 & SGBD relacional & 15.x & 45.55\% de popularidad \cite{stackoverflow_2023_results} & PostgreSQL License \\
\rowcolor{altrow}
Prisma ORM 5 & ORM para Node.js/TS & 5.x & ORM preferido en ecosistema Next.js/TS \cite{prisma_docs} & Apache 2.0 \\
Vercel & Hosting serverless & PaaS & Plataforma l\'ider para despliegue Next.js \cite{vercel_pricing, nextjs} & Propietario \\
\rowcolor{altrow}
...
\midrule
Comensal / Anfitrión & Smartphone personal & Chrome $\geq$90, Firefox $\geq$88 o Safari $\geq$14. Cámara para QR. & El 87.3\% de mexicanos de 18--44 años usa smartphone con internet \cite{inegi_endutih_2022}. \\
\rowcolor{altrow}
...
Límite de conexiones PostgreSQL en funciones serverless &
  ...
  Prisma Accelerate o PgBouncer (integrado en Supabase Pro). Solución probada y documentada \cite{prisma_docs, prisma_accelerate}. \\
\rowcolor{altrow}
...
Latencia de Supabase Realtime bajo carga alta &
  ...
  Supabase Realtime plan Pro soporta hasta 500 conexiones simultáneas. Escalable bajo demanda \cite{supabase_pricing}. \\
\rowcolor{altrow}
...
OE-12 Dashboard & Pipeline Spark (Medallion) + Dashboard multi-nivel & 120 & \$60,000 & 2 \\
\rowcolor{altrow}
...
\midrule
Vercel & Pro (1 seat) & \$20 & \$350 & \$3,850 & vercel.com/pricing (2026) \cite{vercel_pricing} \\
\rowcolor{altrow}
...
\midrule
Stripe & Level 1 PCI DSS & 2.9\% + \$3~MXN (nacional) / 3.6\% + \$3~MXN (int.) & SDK oficial para Next.js (Stripe.js) \cite{pci_dss_4}. \\
\rowcolor{altrow}
