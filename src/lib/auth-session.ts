...
export const DEV_AUTH_SECRET_FALLBACK = "bouquet-dev-auth-secret-change-me-32";
...
export function resolveAuthSecret(): string | undefined {
  ...
  if (process.env.NODE_ENV !== "production") return DEV_AUTH_SECRET_FALLBACK;
  if (process.env.BOUQUET_ADMIN_ALLOW_DEV_AUTH_SECRET === "1") return DEV_AUTH_SECRET_FALLBACK;
  return undefined;
}
