...
export async function hashSuperAdminPassword(plain: string): Promise<string> {
...
export async function verifySuperAdminPassword(plain: string, stored: string): Promise<boolean> {
